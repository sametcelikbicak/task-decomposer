...
> **⚠️ Moved to [`rolecraft-sh/skills`](https://github.com/rolecraft-sh/skills/tree/main/skills/task-decomposer)** — install via `npx rolecraft install task-decomposer`
